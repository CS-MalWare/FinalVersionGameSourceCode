...
public class Master2 extends BaseAppState implements ActionListener {
    ...
    public Master2(Vector3f place){
        this.place=place;
    }
    public Master2(Vector3f place,float modelY){
        this.place=place;
        this.modelY=modelY;
    }
    public void initModel(){
        girl=app.getAssetManager().loadModel("character/master/Master2.j3o");
        girl.setName("girl");
