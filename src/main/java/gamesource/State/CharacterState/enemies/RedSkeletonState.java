...
public class RedSkeletonState extends BaseAppState {
    ...
    private Node rootNode=new Node("Redskeleton");
    ...
    public RedSkeletonState(){

    }
    public RedSkeletonState(Vector3f place){
        this.place=place;
    }
    public RedSkeletonState(Vector3f place,float modelY){
        this.place=place;
        this.modelY=modelY;
    }
    public void initModel(){
        skeleton=app.getAssetManager().loadModel("Enemies/skeleton/redSkeleton/redSkeleton.j3o");
    ...
    public void initAnim(){
        ...
        animChannel.setAnim("archer_shuffle_left");
    }
    @Override
