...
public class robotBoss  extends BaseAppState {
    ...
    public robotBoss(Vector3f place){
        this.place=place;
    }

    public robotBoss(Vector3f place, float  modelY){
        this.place=place;
        this.modelY=modelY;
    }

    public robotBoss(Vector3f place,float modelY,float rotateX,float rotateZ,float rotateY){
        this.modelY=modelY;
        this.place=place;
    ...
    public robotBoss(Vector3f place,float modelY,float rotateX,float rotateZ,float rotateY, int type){
        this.modelY=modelY;
        this.place=place;
        this.rotateX=rotateX;
        this.rotateY=rotateY;
    ...
    public robotBoss(Vector3f place,float modelY,float rotateX,float rotateZ,float rotateY, int type,int time){
        this.modelY=modelY;
        this.place=place;
        this.rotateX=rotateX;
        this.rotateY=rotateY;
    ...
    public void initPhysics(){
        ...
        robot.move(0.06f,-(height/2+radius)+0.1f,0);
    ...
    public void initAnim(){
        ...
        animChannel.setAnim("Threaten");
    }
    public void initModel(){
        robot = app.getAssetManager().loadModel("Enemies/fifthMap/boss/scene.j3o");
