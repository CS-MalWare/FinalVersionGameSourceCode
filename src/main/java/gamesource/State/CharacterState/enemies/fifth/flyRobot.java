...
public class flyRobot  extends BaseAppState {
    ...
    public flyRobot(Vector3f place){
        this.place=place;
    }
    ...
    public flyRobot(Vector3f place,float modelY,float rotateX,float rotateZ,float rotateY){
        this.modelY=modelY;
        this.place=place;
