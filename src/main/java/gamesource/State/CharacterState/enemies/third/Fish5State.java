...
public class Fish5State  extends BaseAppState {
    ...
    public Fish5State(Vector3f place){
        this.place=place;
    }

    public Fish5State(Vector3f place, int modelY){
        this.place=place;
        this.modelY=modelY;
    }

    public Fish5State(Vector3f place,float modelY,float rotateX,float rotateZ,float rotateY){
        this.modelY=modelY;
        this.place=place;
    ...
    public void initModel(){
        robot = app.getAssetManager().loadModel("Enemies/underWater/fish5.j3o");
