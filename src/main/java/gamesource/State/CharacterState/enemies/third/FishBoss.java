...
public class FishBoss extends BaseAppState {
    ...
    public FishBoss(Vector3f place){
        this.place=place;
    }

    public FishBoss(Vector3f place, int modelY){
        this.place=place;
        this.modelY=modelY;
    }

    public FishBoss(Vector3f place,float modelY,float rotateX,float rotateZ,float rotateY){
        this.modelY=modelY;
        this.place=place;
    ...
    public void initPhysics(){
        ...
        robot.move(0.06f,-(height/2+radius)+0.6f,0);
