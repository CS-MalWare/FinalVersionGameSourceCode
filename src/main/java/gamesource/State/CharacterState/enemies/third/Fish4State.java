...
public class Fish4State extends BaseAppState {
    ...
    public Fish4State(Vector3f place){
        this.place=place;
    }

    public Fish4State(Vector3f place, int modelY){
        this.place=place;
        this.modelY=modelY;
    }

    public Fish4State(Vector3f place,float modelY,float rotateX,float rotateZ,float rotateY){
        this.modelY=modelY;
        this.place=place;
    ...
    public void initAnim(){
        ...
        animChannel.setAnim("Armature|AnglerFishBitingOne");
    }
    public void initModel(){
        robot = app.getAssetManager().loadModel("Enemies/underWater/fish4.j3o");
