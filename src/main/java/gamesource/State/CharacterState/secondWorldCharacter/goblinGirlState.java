...
public class goblinGirlState extends BaseAppState {
    ...
    public goblinGirlState(){

    }
    public goblinGirlState(Vector3f place){
        this.place=place;
    }
    public goblinGirlState(Vector3f place,float modelY){
        this.place=place;
        this.modelY=modelY;
    }
    public void initModel(){
        boy=app.getAssetManager().loadModel("character/goblinGirl/scene.j3o");
        boy.setName("boy");
