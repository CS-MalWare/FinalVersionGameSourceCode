...
public class Master1  extends BaseAppState implements ActionListener {
    ...
    public Master1(Vector3f place){
        this.place=place;
    }
    public Master1(Vector3f place,float modelY){
        this.place=place;
        this.modelY=modelY;
    }
    public void initModel(){
        girl=app.getAssetManager().loadModel("character/master/Master1.j3o");
        girl.setName("girl");
