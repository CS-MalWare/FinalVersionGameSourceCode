...
public class lizardState extends BaseAppState {
    ...
    public lizardState(Vector3f place){
        this.place=place;
    }
    public lizardState(Vector3f place,float modelY){
        this.place=place;
        this.modelY=modelY;
    }
    public void initModel(){
        boy=app.getAssetManager().loadModel("character/lizard/scene.j3o");
        boy.setName("boy");
