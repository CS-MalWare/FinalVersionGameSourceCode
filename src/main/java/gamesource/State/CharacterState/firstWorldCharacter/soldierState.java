...
public class soldierState extends BaseAppState implements ActionListener {
    ...
    public soldierState(int model){
        this.model=model;
    }
    public soldierState(int model,float rotateX,float rotateY,float rotateZ){
        //app=(SimpleApplication)application;
        this.model=model;
    ...
    public soldierState(int model,Vector3f place){
        //app=(SimpleApplication)application;
        this.model=model;
        this.place=place;

    }
    public soldierState(int model,Vector3f place,float modelY){
        this.place=place;
        this.model=model;
        this.modelY=modelY;
    }
    public soldierState(int model,Vector3f place,float modelY,float rotateX,float rotateZ,float rotateY){
        this.model=model;
        this.place=place;
        this.modelY=modelY;
        this.rotateX=rotateX;
    ...
    public soldierState(int model,int type){
        //app=(SimpleApplication)application;
        this.model=model;
        this.type=type;
    }
    public soldierState(int model,float rotateX,float rotateY,float rotateZ,int type){
        //app=(SimpleApplication)application;
        this.model=model;
        this.rotateX=rotateX;
        this.rotateY=rotateY;
    ...
    public soldierState(int model,Vector3f place,int type){
        //app=(SimpleApplication)application;
        this.model=model;
        this.place=place;
        this.type=type;
    ...
    public soldierState(int model,Vector3f place,float modelY,int type){
        this.place=place;
        this.model=model;
        this.modelY=modelY;
        this.type=type;
    ...
    public soldierState(int model,Vector3f place,float modelY,float rotateX,float rotateZ,float rotateY,int type){
        this.place=place;
        this.model=model;
        this.modelY=modelY;
        this.rotateX=rotateX;
